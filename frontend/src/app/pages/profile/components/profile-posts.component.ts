      ...
      @if (loading()) {
        ...
        @for (post of posts(); track post.id) {
          <app-post-card
            ...
            (saveEditReply)="saveEditReply.emit({ replyId: $event.replyId, postId: post.id, content: $event.content })"
            ...
            (saveEditNestedReply)="saveEditNestedReply.emit({ replyId: $event.replyId, postId: post.id, content: $event.content })"
